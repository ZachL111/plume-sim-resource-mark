"""Regression checks for the plume-sim-resource-mark casebook."""
...
from casebook.harness import assert_expected, plume_sim_resource_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(plume_sim_resource_mark_summary(), assert_expected())
