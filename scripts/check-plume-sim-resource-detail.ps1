...
$repo = "plume-sim-resource-mark"
$language = "C#"
$category = "Simulations"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/plume-sim-resource-walkthrough.md")) {
...
if ($profile.lowest_case.name -ne "recovery") { throw "$repo profile lowest case changed" }
