...
plume-sim-resource-mark is a C# project for simulations. It focuses on this technical goal: Create a C# reference implementation for resource workflows, centered on event replay, fixture event logs, and golden state snapshots.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 152, risk penalty 5, latency penalty 2, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
